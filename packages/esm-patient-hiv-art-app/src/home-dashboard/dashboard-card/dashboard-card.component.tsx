...
const DashboardCard: React.FC<DashboardCardProps> = ({
  ...
  const cardContainerStyle = customBorderColor ? { borderColor: customBorderColor } : {};

  return (
    <div className={`${styles.dashboardCardContainer} ${styles.customBorder}`} style={cardContainerStyle}>
